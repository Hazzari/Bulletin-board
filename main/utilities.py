...
def send_new_comment_notification(comment):
    ...
    subject = render_to_string('email/new_comment_letter_subject.txt', context=context)
    body_text = render_to_string('email/new_comment_letter_body.txt', context=context)
